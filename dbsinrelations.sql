...
--
-- Servidor: localhost
-- Tiempo de generación: 04-08-2017 a las 00:47:04
...
INSERT INTO `medico` (`id_medico`, `nombre`, `apellidoP`, `apellidoM`, `telefono`, `especialidad`, `cedula`, `id_user`) VALUES
(1, 'Rodolfo ', 'Castellanos', 'del Rio', '8711212377', 'Cirugia', '72737363', 0),
(2, 'Alondra', 'Castillo', 'Cepeda', '87328974', 'Odontologia', '', 0);
...
ALTER TABLE `cita`
  ...
  ADD KEY `cita_ibfk_1` (`id_medico`),
  ADD KEY `cita_ibfk_3` (`id_TipoDeServicio`);
