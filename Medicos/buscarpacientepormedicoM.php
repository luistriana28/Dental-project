...
<html>
    <head>
        <title>Buscar Paciente por Medico</title>
    ...
    <body>
        ...
        <center>
        <h3 id="tit">Buscar Pacientes Por Medico</h3>
        <fieldset id="feel"><form method="post">
            <font id="letras">Seleccione al Medico:</font><br />
            <?php
        ...
        mysqli_select_db($conexion,"dentaltorreon")
        or die ("Problemas de conexion de la base de datos");
        $busca=mysqli_query($conexion,"select id_medico,persona.id_persona,persona.nombre,persona.apellidoP,
        ...
        if($total==0)
        {
        echo "<font color='white'>No hay Pacientes registrados para ese medico</font><br/>";
        }
        else
        {
        echo "<table border='1' bgcolor='silver'>";
            ...
            $id=$reg['nombre'];
            $npaciente=mysqli_query($conexion,"select * from servicio where id_medico='$id'");
