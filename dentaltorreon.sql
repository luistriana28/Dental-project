...
--
-- Servidor: localhost
-- Tiempo de generación: 11-07-2017 a las 03:47:07
...
ALTER TABLE `cita`
  ...
  ADD CONSTRAINT `cita_ibfk_3` FOREIGN KEY (`id_TipoDeServicio`) REFERENCES `tipodeservicio` (`id_TipoDeServicio`);

--
-- Filtros para la tabla `expediente`
--
ALTER TABLE `expediente`
  ADD CONSTRAINT `expediente_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`);

--
-- Filtros para la tabla `receta`
--
ALTER TABLE `receta`
  ADD CONSTRAINT `receta_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`),
  ADD CONSTRAINT `receta_ibfk_2` FOREIGN KEY (`id_medico`) REFERENCES `medico` (`id_medico`);

--
-- Filtros para la tabla `servicio`
--
ALTER TABLE `servicio`
  ADD CONSTRAINT `servicio_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`),
  ADD CONSTRAINT `servicio_ibfk_2` FOREIGN KEY (`id_TipoDeServicio`) REFERENCES `tipodeservicio` (`id_TipoDeServicio`),
  ADD CONSTRAINT `servicio_ibfk_3` FOREIGN KEY (`id_medico`) REFERENCES `medico` (`id_medico`);

--
-- Filtros para la tabla `tratamiento`
--
ALTER TABLE `tratamiento`
  ADD CONSTRAINT `tratamiento_ibfk_1` FOREIGN KEY (`id_TipoDeServicio`) REFERENCES `tipodeservicio` (`id_TipoDeServicio`);
COMMIT;
